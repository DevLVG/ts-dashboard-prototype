...
export const PLMatrix = ({ data, onServiceClick }: PLMatrixProps) => {
  ...
  const MetricCell = ({ actual, budget }: { actual: number; budget: number }) => {
          ...
          return (
            ...
            <div
              ...
              >
                ...
                <MetricCell actual={bu.opex.actual} budget={bu.opex.budget} />
                ...
                <div className="ml-8 space-y-1 pb-2">
                  {bu.services.map((service) => (
                    ...
                    >
                      ...
                      <MetricCell actual={service.opex.actual} budget={service.opex.budget} />
